...
void nvttSetOutputOptionsFileStream(NvttOutputOptions * outputOptions, FILE * fileStream, NvttBoolean autoclose)
{
  outputOptions->setFileStream(fileStream, autoclose != NVTT_False);
}
